...
<!-- Please read https://github.com/linuxserver/docker-freetube/blob/selkies/.github/CONTRIBUTING.md -->
...
Simply pulling `lscr.io/linuxserver/freetube:selkies` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* Image version number:
    ...
    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/freetube:selkies
    ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/freetube:selkies
    ```
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/freetube:selkies .
```
